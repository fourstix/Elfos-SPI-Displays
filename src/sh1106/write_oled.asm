...
; Name: write_oled
;
; Write bytes to display using the SH1106 controller chip connected to port 0
...
;
; Parameters: rf - pointer to buffer with bytes.
;             r8 - counter for number of bytes to write
; Return: None
;-------------------------------------------------------------------------------
            proc    write_oled
...
wb_loop:    lda     rf              ; get byte from buffer
            str     r2              ; save at M(X)
